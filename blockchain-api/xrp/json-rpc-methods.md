...
You can review the official [**XRP RPC documentation HERE**](https://xrpl.org/docs)

### Example RPC

{% tabs %}
{% tab title="Curl" %}
<pre><code><strong>curl https://api.chainup.net/xrp/mainnet/&#x3C;YOUR_API_KEY> \
</strong>-X POST \
...
r = requests.post(url="https://api.chainup.net/xrp/mainnet/<YOUR_API_KEY>", headers=headers, data=payload)
